...
st.title("MA MAISON SN: le meilleur site de Prédiction de prix des maisons")
st.subheader('Application réalisée par Cheikh Oumar Niass,Pape Alassane Coly, Marie Fall et Ramatoulaye katy Baldé')
